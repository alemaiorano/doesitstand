    ...
    "v3": {
        ...
        "reviewer_b": {
            ...
            "user": (
                ...
                "affects your assessment, but it should not count against the paper.\n"
                "\n"
                "REPRODUCIBILITY CHECKLIST — systematically evaluate whether the paper provides:\n"
                "1. Model/tool name and specific version used (e.g., 'GPT-4o', not just 'LLM')\n"
                "2. Key hyperparameters (temperature, top-p, seed, etc.) or explicit statement of defaults\n"
                "3. Full prompt text or templates (in paper or appendix)\n"
                "4. Code/data availability statement or link\n"
                "5. Detailed pipeline/workflow description sufficient for replication\n"
                "6. Statistical analysis details (CIs, significance tests, sample sizes)\n"
                "If the paper provides these in an appendix or supplementary material, credit "
                "it accordingly — reproducibility details need not be in the main text.\n"
                "\n"
                "Output JSON schema:\n"
                "{{\n"
                '  "review_markdown": string\n'
        ...
        "meta_score": {
            ...
            "user": (
                ...
                "\n"
                "Per-dimension scoring guidance (1-10 scale):\n"
                "- originality: Novelty of contribution. 1-3 = incremental/minor; 4-6 = "
                "solid but expected; 7-8 = clearly novel; 9-10 = groundbreaking.\n"
                "- quality: Technical soundness, rigor, experimental methodology. 1-3 = "
                "flawed; 4-6 = adequate with gaps; 7-8 = rigorous; 9-10 = exemplary.\n"
                "- clarity: Writing quality, structure, accessibility. 1-3 = unclear; "
                "4-6 = readable but could improve; 7-8 = well-written; 9-10 = exemplary.\n"
                "- significance: Impact on the field. 1-3 = niche/minor; 4-6 = useful; "
                "7-8 = important; 9-10 = field-shaping.\n"
                "- reproducibility: Can others replicate the work? 1-3 = insufficient "
                "detail (missing model version, hyperparams, code); 4-6 = partial detail "
                "but gaps remain; 7-8 = sufficient detail including model specs, "
                "hyperparams, prompts, and/or code; 9-10 = full replication package. "
                "IMPORTANT: If the paper includes an appendix or supplementary with "
                "pipeline details, model versions, hyperparameters, or full prompts, "
                "credit that — reproducibility detail in appendices counts.\n"
                "- overall: Holistic assessment reflecting all dimensions.\n"
                "\n"
                "IMPORTANT constraints:\n"
